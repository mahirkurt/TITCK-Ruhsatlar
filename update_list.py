...
FILES_TO_DOWNLOAD = [
    {
        "output_filename": "ilac_fiyat_listesi.xlsx",
        "page_url": "https://titck.gov.tr/dinamikmodul/100"
    },
    {
        "output_filename": "ruhsatli_ilaclar_listesi.xlsx",
        "page_url": "https://www.titck.gov.tr/dinamikmodul/85"
    },
    {
        "output_filename": "etkin_madde_listesi.xlsx",
        "page_url": "https://www.titck.gov.tr/dinamikmodul/108"
    },
    {
        "output_filename": "yurtdisi_etkin_madde_listesi.xlsx",
        "page_url": "https://www.titck.gov.tr/dinamikmodul/126"
    },
    {
        "output_filename": "skrs_erecete_listesi.xlsx",
        "page_url": "https://www.titck.gov.tr/dinamikmodul/43"
    }
]
...
def download_from_page(config):
    ...
    try:
        ...
        excel_link_tag = soup.find(
            "a", href=lambda href: href and href.lower().endswith(".xlsx")
        )

        if not excel_link_tag:
            logging.error(
                f"'{page_url}' sayfasında .xlsx uzantılı bir indirme linki bulunamadı."
            )
            return False
        ...
        # Düzeltilen satır: response → file_response
